 ...
 * Converted from Zumo32U4 to ZumoShield
 * Zumo32U4 version - Video Explanation: https://youtu.be/mv8Kxi9K_sY
 */
...
void loop() {
  ...
  */
  ...
  if (state != ready_state && curSpeed < motorSpeed) {
